...
\section{Входные данные}
        \begin{itemize}
            \item Размер выборки генеральной совокупности для построения гистограммы: $n = 10^6$
	    \item Размер выборки генеральной совокупности для проверки критерия $\chi^2$: $n = 10^4$
